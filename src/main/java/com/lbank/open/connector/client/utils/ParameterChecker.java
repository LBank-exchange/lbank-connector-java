...
public final class ParameterChecker {
    ...
    public static void checkRequiredParameter(Map<String, Object> parameters, String parameter) {
        if (!parameters.containsKey(parameter)) {
            throw new LbankConnectorException(String.format("\"%s\" is a mandatory parameter!", parameter));
        }
    }

    public static void checkParameterType(Object parameter, Class<?> t, String name) {
        if (!t.isInstance(parameter)) {
            throw new LbankConnectorException(String.format("\"%s\" must be of %s type.", name, t));
        } else if (parameter instanceof String && ((String) parameter).isEmpty()) {
            throw new LbankConnectorException(String.format("\"%s\" must not be empty.", name));
        }
    }

    public static Object processId(Object id, String name) {
        if (!(id instanceof Integer || id instanceof String || id == null)) {
            throw new LbankConnectorException(name + " must be of Int or String type.");
    ...
    public static void checkOnlyOneOfParameters(Map<String, Object> params, String... parameters) {
        ...
        if (params != null) {
            ...
            if (count > countFinal) { // more than one parameter is present
                throw new LbankConnectorException("Only one of the following parameters is allowed: " + Arrays.toString(parameters));
            }
        }
    }

    public static void checkOneOfParametersRequired(Map<String, Object> params, String... parameters) {
        ...
        if (params != null) {
            ...
            if (count == parameters.length) { // none of the parameters is present
                throw new LbankConnectorException(exceptMsg);
            }
        } else {
            throw new LbankConnectorException(exceptMsg);
        }
